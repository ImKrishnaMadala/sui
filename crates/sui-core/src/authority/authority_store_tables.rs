...
pub struct AuthorityEpochTables<S> {
    ...
    /// TODO: this may be superseded by storing consensus execution and checkpoint execution
    /// progress. If possible, remove this table and replay the certificates from consensus and
